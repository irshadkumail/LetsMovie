 ...
 */
public class FragmentB extends Fragment implements CardViewHolder.OnMyItemClicked {
    ...
    public View onCreateView(LayoutInflater layoutInflater,ViewGroup parent,Bundle bundle)
    {
        ...
        recyclerView= (RecyclerView) view.findViewById(R.id.recycler_b);
        setLayoutManager();
        getJson();
    ...
    public void getJson()
    {
        ...
        JsonObjectRequest jsonObjectRequest= new JsonObjectRequest(Request.Method.GET,"http://api.themoviedb.org/3/movie/upcoming?api_key=ce011fa6eca448775cf42ad614c86548",null,new Response.Listener<JSONObject>() {
            @Override
    ...
    public ArrayList<Movie> parseJson(JSONObject jsonObject)
    {
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++) {
                ...
                String movie_title =current.getString("title");
                ...
                String poster_poth=current.getString("poster_path");

            Movie movie= new Movie(movie_title,release_date,overview,language,ratings,poster_poth);
                arrayList.add(movie);
    ...
    class MyRecyclerAdapter extends RecyclerView.Adapter<CardViewHolder>
    {
        ...
        public CardViewHolder onCreateViewHolder(ViewGroup parent,int pos)
        {
            ...
            cardViewHolder.setOnMyItemClicked(FragmentB.this);
